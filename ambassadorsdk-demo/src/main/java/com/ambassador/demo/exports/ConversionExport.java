...
public class ConversionExport extends BaseExport<ConversionParameters> {
    ...
    public String getReadme() {
        ...
        readme.addHtmlLine("Check out the MyApplication.java file for an example of this conversion request.");
        ...
        readme.addHtmlLine("Check out the AppDelegate.m or AppDelegate.swift files for examples of this conversion request.");
