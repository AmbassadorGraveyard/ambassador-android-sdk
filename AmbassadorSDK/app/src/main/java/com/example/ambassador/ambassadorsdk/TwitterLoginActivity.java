...
//        wvTwitter.loadUrl("https://api.twitter.com/oauth/request_token");
        ...
        loginButton.setCallback(new Callback<TwitterSession>() {
            ...
            public void success(Result<TwitterSession> result) {
                ...
                AmbassadorSingleton.getInstance().setTwitterToken(session.getAuthToken().token);
                AmbassadorSingleton.getInstance().setTwitterTokenSecret(session.getAuthToken().secret);
            }
