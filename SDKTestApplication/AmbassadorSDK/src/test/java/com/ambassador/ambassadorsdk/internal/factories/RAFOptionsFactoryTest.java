...
public class RAFOptionsFactoryTest {
    ...
    @Test
    public void decodeResourcesLinkedInToolbarTest() throws Exception {
        // ARRANGE
        String type = "color";
        String key = "linkedintoolbar";
        String value = "#ffffff";
        mockOption(type, key, value);
    ...
    @Test
    public void decodeResourcesLinkedInToolbarTextTest() throws Exception {
        // ARRANGE
        String type = "color";
        String key = "linkedintoolbartext";
        String value = "#ffffff";
        mockOption(type, key, value);
        ...
        // ASSERT
        Assert.assertEquals(-2, rafOptions.getLinkedInToolbarTextColor());
    }

    @Test
    public void decodeResourcesLinkedInToolbarArrowTest() throws Exception {
        // ARRANGE
        String type = "color";
        String key = "linkedintoolbararrow";
        String value = "#ffffff";
        mockOption(type, key, value);
        ...
        // ASSERT
        Assert.assertEquals(-2, rafOptions.getLinkedInToolbarArrowColor());
    }
